...
public class Devolucao extends javax.swing.JFrame {
    ...
    //Preenche o combobox do Livro com os livros da lista
    public void preencheLivros(){
        for(int i=0; i<this.l.getEmprestados().size(); i++){
            this.cbLivro.addItem(this.l.getEmprestados().get(i).getTítulo());
        }
    }    
